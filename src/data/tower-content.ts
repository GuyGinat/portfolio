...
export const towerContent: ContentBlock[] = [
  {
    type: 'text',
    title: 'Introduction',
    content: "For a long time I have been infatuated with systemic games, as a kid I played mostly games that were focused on systems, more than just systems, I really like grids (as you have may have noticed from this website). They seem to fit very well with games as they offer a set of constraints by default, proximity and distance are discrete singular numbers, rows and columns have a unique relationship between each other, and within themselves, a relationship that doesn't exist in a continuous space, they offer tactility that lends itself well to turn based game design."
  },
  {
    type: 'text',
    content: ' When I started making games I was drawn into making grid based games (some of them you can play here!), after making a couple I wanted to mix things up, the thought was \"let\'s try and make a grid, but circle!\" and off we weny to the races, resulting in this:'
  },
  {
    type: 'image',
  ...
  {
    type: 'text',
    content: "No game yet, just a radial grid, or more accurately a way to create radial grids, by defining how many rings and how many segments each ring has, functionalities to rotate rings and push / pull segments, place walls between them and a bunch of other things.\n\nAnd, the start of my maddening trip of finding what is interesting about this thing. So lets take a look at some of the games I tried to make with this system."
  },
  {
    type: 'text',
    content: "A small note before we start, I highly recommend playing these games in full screen, on a pc (phone is not supported). Also, some of these games have sound, some don't, and! they are prototypes, so they are not perfect, but they are fun to play and I hope you enjoy them.\n\nAlso, this project has been made as a part of my NYU Game Center Game Design Thesis, there is a museum like experience build walking you through the personal process of developing these games that you can download here.",
    style: {
      marginBottom: 100,
  ...
  },
  {
    title: 'Tactics',
    type: 'text',
    content: "This one prototype is the one I probably spent the most time on.\nHeavily inspired by tactical games that have you planning you next move and then executing it. This go around, after making the core mechanics my assumption was that what was holding me back from sticking to working on this game was visuals, it just got pretty stale looking at the same boring grid over and over again, so I thought why not just make the background scene more a bit interesting?\nIt does look cool, and it definitely helps with my motivation. Since it is not tutorialized, I will explain a bit of what you can do here.\nYou can start by hitting the \"Generate Level\" button on the right of the screen there under the Debug Panel, then you can hover over different characters to see some basic stats on them. Your character is the warrior, and once you click on it you should be able to hover over its action buttons to see their effects and range. The goal was to survive for X amount of turns, while enemies will spawn in waves after each turn (indicated by the red skull on certain segments). I really liked the vibes here, it is still very much a prototype and a lot of stuff is missing, but this feels more like an actual start of a game. Another cool thing I added to this one is how you can control the grid, once you click the rotate action you can hit \"Q\" or \"E\" to rotate, \"W\" and \"S\" to change selected ring, and \"Tab\" to change between a ring rotation and a line push / pull, and you have to hit \"Enter\" to confirm the action or \"X\" to cancel it.\""
  },
  {
    type: 'image',
    url: '/images/tower/tower.png',
  ...
  {
    type: 'text',
    content: "You probably noticed by this point that it is pretty janky, and so early into developing a game I found myself putting out fires everywhere in my code. I had this notion in mind that when it would be the right game it will be easy. I wanted this game to be that, but it was not, it was complicated and messy and I was not having fun. So I just decided to move on, make something else.\nWhat do you think?"
  },
  {
    title: 'Tetris',
    type: 'text',
